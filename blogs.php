...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_blog'])) {
    if (isset($_SESSION['user'])) {
        ...
        $sql = "INSERT INTO blogs (user_name, title, content, location, rating, created_at) 
                VALUES ('$user', '$title', '$content', '$location', $rating, NOW())";
        
        if ($conn->query($sql)) {
            $success_message = "Blog posted successfully!";
        } else {
            $error_message = "Error posting blog: " . $conn->error;
        }
    } else {
        $error_message = "Please login to post a blog";
    }
}
...
<head>
    ...
    <title>Travel Blogs - HOVI & JAVI</title>
...
<header class="site-header">
    ...
    <section class="blog-section">
        <div class="container">
            <div class="section-header text-center">
                ...
                <p class="section-subtitle">Share your travel experiences and help others discover amazing places in India</p>
            </div>
            ...
            <div class="blog-container">
                ...
                <div class="blog-form">
                    ...
                    <input type="radio" name="rating" value="1" id="star1"><label for="star1">★</label>
                        ...
                        <button type="submit" name="submit_blog" class="btn btn-primary btn-block">Post Blog</button>
                    </form>
                </div>
                ...
                <?php if($result->num_rows > 0): ?>
                    <?php while($blog = $result->fetch_assoc()): ?>
                        <div class="blog-card">
                            <div class="blog-header">
                                <div class="blog-meta">
                                    <span class="author"><?php echo htmlspecialchars($blog['user_name']); ?></span>
                                    <span class="date"><?php echo date('M d, Y', strtotime($blog['created_at'])); ?></span>
                                </div>
                                <div class="blog-rating">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <i class="fas fa-star <?php echo $i <= $blog['rating'] ? 'text-primary' : 'text-muted'; ?>"></i>
                                    <?php endfor; ?>
                                </div>
                            </div>
                            ...
                            <div class="blog-location">
                                ...
                                <?php echo htmlspecialchars($blog['location']); ?>
                            </div>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p class="text-center">No blog posts yet. Be the first to share your experience!</p>
                <?php endif; ?>
            </div>
        </div>
    </section>

    <!-- Include the footer from your about us page -->
    ...
    <script>
        // Include the JavaScript from your about us page
